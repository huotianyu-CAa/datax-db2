...
public class CommonRdbmsWriter {
    ...
    public static class Task {
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            this.writeRecordSql = String.format(INSERT_OR_REPLACE_TEMPLATE, this.table,this.table);
        ...
        public void startWriteWithConnection(RecordReceiver recordReceiver, TaskPluginCollector taskPluginCollector, Connection connection) {
            ...
            LOG.info("userLog:"+this.dataBaseType+","+writeMode+","+writeMode.trim().toLowerCase().startsWith("update"));
            if (this.dataBaseType == DataBaseType.RDBMS && writeMode.trim().toLowerCase().startsWith("update") ) {
                LOG.info("userLog:first success");
        ...
        private void calcWriteRecordSql() {
            if (!VALUE_HOLDER.equals(calcValueHolder(""))) {
                ...
                LOG.info("userLog:sql success-"+writeRecordSql);
            }
        }

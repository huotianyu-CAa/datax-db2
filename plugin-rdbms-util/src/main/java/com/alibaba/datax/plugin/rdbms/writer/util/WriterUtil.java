...
public final class WriterUtil {
    ...
    public static String getWriteTemplate(List<String> columnHolders, List<String> valueHolders, String writeMode, DataBaseType dataBaseType, boolean forceUseUpdate) {
        ...
        LOG.info("userLog:"+writeMode+","+dataBaseType+","+writeMode.trim().toLowerCase().startsWith("update"));
        if (forceUseUpdate ||
            ...
            writeDataSqlTemplate = new StringBuilder()
                    ...
                    .toString();
        } else if(dataBaseType==DataBaseType.RDBMS&&writeMode.trim().toLowerCase().startsWith("update")){
            writeDataSqlTemplate=new StringBuilder()
                    .append(onMergeIntoDoString(writeMode, columnHolders, valueHolders))
        ...
        LOG.info("userLog:"+writeDataSqlTemplate);
